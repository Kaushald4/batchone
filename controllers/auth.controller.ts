import { Request, RequestX, Response } from "express";
...
export const forgotPassword = asyncHandler(async (req: Request, res: Response) => {
    ...
    try {
        ...
        user.forgotPasswordExpire = undefined as any;
...
export const resetPassword = asyncHandler(async (req: RequestX, res: Response) => {
 ...
 ******************************************************/
export const changePassword = asyncHandler(async (req: RequestX, res: Response) => {
 ...
 * @returns User Object
 ******************************************************/
export const getProfile = asyncHandler(async (req: RequestX, res: Response) => {
    const { user } = req;
    if (!user) {
        throw new CustomError("User not found", 404);
    }
